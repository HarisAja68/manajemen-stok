...
<div class="card">
    <div class="card-header">
        <a class="btn btn-primary btn-sm" href="{{ route('user.create') }}" role="button"><i class="fas fa-plus"></i>
            Tambah Data</a>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <table id="tabel" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $data->role}}</td>
                    <td>
                        <a href="{{ route('user.edit', $data->id) }}" class="btn btn-sm btn-warning"><i
                                class="fas fa-edit"> Edit</i></a>
                        <form class="d-inline" action="{{ route('user.destroy', $data->id) }}" role="alert"
                            method="POST">
                            @csrf
                            @method('DELETE')
